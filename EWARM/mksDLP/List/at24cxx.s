///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       16/Apr/2020  18:38:30
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\Drivers\BSP\Components\at24cxx\at24cxx.cpp
//    Command line =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\Drivers\BSP\Components\at24cxx\at24cxx.cpp
...
//    List file    =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\EWARM\mksDLP/List\at24cxx.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  267 //	{
//  268 //		AT24CXX_WriteByte(MemAddress,*pBuffer);
//  269 //		MemAddress++;
//  270 //		pBuffer++;
//  271 //	}
//  272 	return err;
...
//  274 
//  275 /**
//  276   * @brief  Reads data from I2C EEPROM driver in using DMA channel.
//  277   * @param  MemAddress: memory address
//  278   * @param  pBuffer: Pointer to data buffer
//  279   * @param  BufferSize: Amount of data to be read
...
//  281   */
        ...
        THUMB
//  282 HAL_StatusTypeDef AT24CXX_Read(uint16_t MemAddress, uint8_t* pBuffer, uint32_t BufferSize)
//  283 {
AT24CXX_Read:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  284   return (I2Cx_ReadMultiple((AT24CXX_ADDRESS+((MemAddress/256)<<1)), MemAddress, AT24CXX_MEMADD_SIZE, pBuffer, BufferSize));    
        UXTH     R2,R2
        STR      R2,[SP, #+0]
        MOV      R3,R1
        MOVS     R2,#+1
...
//  286 
//  287 /**
//  288   * @brief  Checks if target device is ready for communication. 
//  289   * @note   This function is used with Memory devices
//  290   * @param  Trials: Number of trials
...
//  292   */
        ...
        THUMB
//  293 HAL_StatusTypeDef AT24CXX_IsDeviceReady(uint32_t Trials)
//  294 { 
//  295   return (I2Cx_IsDeviceReady(AT24CXX_ADDRESS, Trials));
...
//  297 
//  298 //检查AT24CXX是否正常
//  299 //这里用了24XX的最后一个地址(2047)来存储标志字.
//  300 //如果用其他24C系列,这个地址要修改
//  301 //返回1:检测失败
//  302 //返回0:检测成功
        ...
        THUMB
//  303 uint8_t AT24CXX_Check(void)
//  304 {
AT24CXX_Check:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  305 	uint8_t temp;
//  306 	temp=AT24CXX_ReadByte(AT24CXX_TYPE);//避免每次开机都写AT24CXX			   
//  307 	if(temp==0XAA)return 0;		   
        MOVS     R0,#+255
...
//  309 	{
//  310             AT24CXX_WriteByte(AT24CXX_TYPE,0XAA);
??AT24CXX_Check_0:
        MOVS     R1,#+170
        MOVS     R0,#+255
          CFI FunCall AT24CXX_WriteByte
        BL       AT24CXX_WriteByte
//  311 	    temp=AT24CXX_ReadByte(AT24CXX_TYPE);	  
//  312             if(temp==0XAA)return 0;
        MOVS     R0,#+255
          CFI FunCall AT24CXX_ReadByte
        BL       AT24CXX_ReadByte
        CMP      R0,#+170
