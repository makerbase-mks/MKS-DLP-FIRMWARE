...
//    Endian       =  little
//    Source file  =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\User\ui\QRENCODE\QR_Encode.c
//    Command line =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\User\ui\QRENCODE\QR_Encode.c
...
//    List file    =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\EWARM\mksDLP/List\QR_Encode.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  755 Encoding		Ver.1–9		10–26		27–40
...
// 1756 											 (! (m_byModuleData[i][j + 1] & 0x11))  && // 柧 - 1
// 1757 											 (   m_byModuleData[i][j + 2] & 0x11)   && // 埫 劉
// 1758 											 (   m_byModuleData[i][j + 3] & 0x11)   && // 埫 劆3
// 1759 											 (   m_byModuleData[i][j + 4] & 0x11)   && // 埫 劊
...
// 1783 											 (! (m_byModuleData[j + 1][i] & 0x11))  && // 柧 - 1
// 1784 											 (   m_byModuleData[j + 2][i] & 0x11)   && // 埫 劉
// 1785 											 (   m_byModuleData[j + 3][i] & 0x11)   && // 埫 劆3
// 1786 											 (   m_byModuleData[j + 4][i] & 0x11)   && // 埫 劊
