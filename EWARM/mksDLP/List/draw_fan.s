///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       16/Apr/2020  18:38:39
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\User\ui\draw_fan.cpp
//    Command line =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\User\ui\draw_fan.cpp -D
...
//    List file    =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\EWARM\mksDLP/List\draw_fan.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  106 						MKS_FAN_TIM = fanSpeeds[0]*10000/255;
        MOVW     R0,#+10000
        LDR.W    R1,??DataTable12_6  ;; 0x42408288
        STR      R0,[R1, #+0]
//  107 					}
//  108 					disp_fan_speed();
        POP      {R0,R4,R5,LR}
...
//  176 						if(fanSpeeds[0]<255)
        ...
        LDR      R2,[R1, #+0]
        MOVW     R3,#+10000
        LDR.W    R0,??DataTable12_6  ;; 0x42408288
        CMP      R2,#+255
        BGE.N    ??cbFanWin_10
//  177 						{
