///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       16/Apr/2020  18:39:16
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\Drivers\BSP\Components\SSD2828\ssd2828.cpp
//    Command line =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\Drivers\BSP\Components\SSD2828\ssd2828.cpp
...
//    List file    =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\EWARM\mksDLP/List\ssd2828.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   82 	SSD2828_SDC_OP = 0;
??read_data_1:
        LDR.W    R5,??DataTable10  ;; 0x4241028c
        MOVS     R0,#+0
        STR      R0,[R5, #+4]
...
??write_data_1:
        LDR.W    R7,??DataTable10  ;; 0x4241028c
        MOVS     R0,#+0
        STR      R0,[R7, #+4]
...
??write_byte_1:
        LDR.W    R6,??DataTable10  ;; 0x4241028c
        MOVS     R0,#+0
        STR      R0,[R6, #+4]
...
??read_mipi_1:
        LDR.N    R5,??DataTable10  ;; 0x4241028c
        MOVS     R0,#+0
        STR      R0,[R5, #+4]
