///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       16/Apr/2020  18:38:37
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\User\ui\draw_ExposureTest.cpp
//    Command line =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\User\ui\draw_ExposureTest.cpp
...
//    List file    =  
//        D:\DLP_proj\DLP_github\MKS-DLP-FIRMWARE\EWARM\mksDLP/List\draw_ExposureTest.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   96     GUI_Exec();
        ...
        BL       GUI_Exec
//   97     //重新初始化2k屏，避免长时间待机之后，2k屏无法正常打印。
//   98     mksdlp.ssd.init();    
...
//  100 
        ...
        THUMB
//  101 void exposure_msg_display(char exposure_msg)
//  102 {
...
//  106         {
//  107             case 1:  
//  108                BUTTON_SetText(buttonTextfront.btnHandle, detection_menu.exposure_start); 
...
//  109             break;
//  110             case 2:
//  111                 BUTTON_SetText(buttonTextfront.btnHandle, detection_menu.exposure_ing);
...
//  112             break;
//  113             case 3:
//  114                 BUTTON_SetText(buttonTextfront.btnHandle, detection_menu.exposure_end);
...
//  121 	GUI_SetBkColor(gCfgItems.background_color);
        ...
        LDR      R0,[R0, #+4]
          CFI FunCall GUI_SetBkColor
        BL       GUI_SetBkColor
//  122 	if(WM_IsWindow(hExposureTestWnd))
...
//  123 	{
//  124 		WM_DeleteWindow(hExposureTestWnd);
        LDRSH    R0,[R4, #+0]
        POP      {R4,LR}
          CFI R4 SameValue
          CFI R14 SameValue
