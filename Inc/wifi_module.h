...
#endif
#define WIFI_SET()        HAL_GPIO_WritePin(GPIOG, GPIO_Pin_1, GPIO_PIN_SET)
#define WIFI_RESET()      HAL_GPIO_WritePin(GPIOG, GPIO_Pin_1, GPIO_PIN_RESET)
...
#define WIFI_IO1_SET()    HAL_GPIO_WritePin(GPIOB, GPIO_Pin_12, GPIO_PIN_SET)
#define WIFI_IO1_RESET()  HAL_GPIO_WritePin(GPIOB, GPIO_Pin_12, GPIO_PIN_RESET);
