...
//#define SDA_IN()  {GPIOB->CRL&=0X0FFFFFFF;GPIOB->CRL|=(u32)8<<28;}	//F1XX
#define SDA_IN()	{GPIOB->MODER&=0XFFFF3FFF;GPIOB->MODER|=(u32)0<<14;}	//F407

//#define SDA_OUT() {GPIOB->CRL&=0X0FFFFFFF;GPIOB->CRL|=(u32)3<<28;}
#define SDA_OUT()  do{GPIOB->MODER&=0XFFFF3FFF;GPIOB->MODER|=(u32)1<<14;GPIOB->OTYPER&=0XFFFF7FFF;GPIOB->OTYPER|=(u32)0<<15;GPIOB->OSPEEDR&=0XFFFF3FFF;GPIOB->OSPEEDR|=(u32)1<<14;}while(0)
...
*/
void delay_us(uint16_t __IO nus)
{
      while(nus--)
      {
...
//对72M条件下,nms<=1864 
void delay_ms(uint16_t __IO nms)
{	 
