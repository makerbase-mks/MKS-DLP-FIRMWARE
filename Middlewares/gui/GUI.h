...
#define GUI_TA_HORIZONTAL  ((3<<0)|(1<<4))//(3<<0)
...
int GUI_TOUCH_X_MeasureXY(unsigned short *pX, unsigned short *pY);
...
#define TOUCH_X_MeasureXY	GUI_TOUCH_X_MeasureXY
