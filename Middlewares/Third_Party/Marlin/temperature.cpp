...
void Temperature::set_current_temp_raw() {
    ...
    current_temperature_raw[0] = raw_temp_value[0];	//mks 2018-08
  #endif
  #if HAS_TEMP_1
    #if ENABLED(TEMP_SENSOR_1_AS_REDUNDANT)
...
//void Temperature::isr() {
  ...
  ISR_STATICS(0);
    ...
    if (pwm_count_tmp >= 127) {
	  ...
	  if(soft_pwm_count_0 > pwm_mask) WRITE_HEATER_0(HIGH);
		...
		if(soft_pwm_count_BED > pwm_mask) WRITE_HEATER_BED(HIGH);
  ...
  switch (adc_sensor_state) {
    ...
    case SensorsReady: {
      ...
      case MeasureTemp_0:
			...
			raw_temp_value[0] += uhADCxConvertedValue[1]>>2;	//TH1
		#elif defined(MKS_ROBINPRO) || defined(MKS_ROBIN2) || defined(MKS_ROBIN2MINI)
			raw_temp_value[0] += uhADCxConvertedValue[1];   	//TH1
		#endif 
      ...
      case MeasureTemp_BED:
			#if defined(MKS_ROBIN_LITE) || defined(MKS_ROBIN) || defined(MKS_ROBINMINI)
				raw_temp_bed_value += uhADCxConvertedValue[0]>>2;	//TB
			#elif defined(MKS_ROBINPRO) || defined(MKS_ROBIN2) || defined(MKS_ROBIN2MINI)
				raw_temp_bed_value += uhADCxConvertedValue[0];	//TB
			#endif 		
        break;
    #endif
      ...
      case MeasureTemp_1:
		#if defined(MKS_ROBIN_LITE) || defined(MKS_ROBIN) || defined(MKS_ROBINMINI)
			raw_temp_value[1] += uhADCxConvertedValue[2]>>2;		//TH2
		#elif defined(MKS_ROBINPRO) || defined(MKS_ROBIN2) || defined(MKS_ROBIN2MINI)
			raw_temp_value[1] += uhADCxConvertedValue[2];   //TH2
		#endif 
