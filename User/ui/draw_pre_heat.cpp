...
#define GUI_FLASH
#endif
#define HEATER_0_MAXTEMP 275    //mks 2018-08
...
#else
							if((int)thermalManager.target_temperature[gCfgItems.curSprayerChoose] > (HEATER_0_MAXTEMP - (WATCH_TEMP_INCREASE + TEMP_HYSTERESIS + 1)))
#endif                                                          
							{
								//thermalManager.target_temperature[gCfgItems.curSprayerChoose] = (float)mksCfg.heater_0_maxtemp - (WATCH_TEMP_INCREASE + TEMP_HYSTERESIS + 1);
                                                                thermalManager.target_temperature[gCfgItems.curSprayerChoose] = (float)HEATER_0_MAXTEMP - (WATCH_TEMP_INCREASE + TEMP_HYSTERESIS + 1);
