#ifndef _LANGUAGE_S_CN_H
#define _LANGUAGE_S_CN_H
//*************简体中文***********************//
#define SERVICE_WEBSITE_CN           "网址:"
#define SERVICE_EMAIL_CN             "邮箱:"

#define INFO_SYSTOM_CN              "系统:"
#define INFO_FIRMWARE_CN            "固件版本:"
#define INFO_SYSTOM_VAL_CN          "MKS DLP"
#define INFO_FIRMWARE_VAL_CN        "1.0.0"

#define DETECTION_TIP_CN            "请设置测试图片的曝光时间"
#define EXPOSURE_TIME_START_CN      "开始"
#define EXPOSURE_TIME_ING_CN        "测试图片曝光中"
#define EXPOSURE_TIME_END_CN        "曝光结束!"

#define DIALOG_DEL_FILE_TIPS_CN     "确定删除该文件?"

#define BOTTOMLAYER_CN              "底层层数 :"
#define EXPOSURE_OFF_CN             "灭灯时间(S) :"
#define BOTTOM_EXPOSURE_CN          "底层曝光时间(S) :"
#define NORMAL_EXPOSURE_CN          "正常曝光时间(S) :"

#define DIALOG_HOME_TIPS_CN              "请先归零,然后手动界面移动Z到底"
#define DIALOG_ZOFFSET_TIPS_CN      "此操作将影响Z零点位置是否继续?"

#define SERVICE_CN                  "服务"
#define INFOMATION_CN               "信息"
...
#define NO_FILE_AND_CHECK_CN			"无文件!请插入u盘!"
...
#define DIALOG_ERROR_TIPS1_CN				"错误:找不到文件,请检查u盘!"
