...
//********************************************//
//Ê≥®ÊÑèÔºöÁî±‰∫éÊòæÁ§∫Â≠óÁ¨¶ÁöÑÁºñÁ†ÅÈóÆÈ¢òÔºåÊâÄ‰ª•‰ª•‰∏ã‰∏≠ÊñáÂ≠ó‰ΩìÂøÖÈ°ªÈááÁî®ANSIÊâìÂºÄÂíå‰øùÂ≠ò„ÄÇ
//”…”⁄œ÷ µ◊÷∑˚±‡¬ÎŒ Ã‚£¨À˘“‘“‘œ¬÷–Œƒ◊÷±ÿ–Î“‘ANSI±Í◊º∏Ò Ωœ‘ æ
//"’˝‘⁄¥Ú”°""≤Ÿ◊˜""‘›Õ£"»˝∏ˆΩÁ√Êµƒ±ÍÃ‚¿∏÷ª◊ˆ"÷–”¢«–ªª"°£
//"Ê≠£Âú®ÊâìÂç∞""Êìç‰Ωú""ÊöÇÂÅú"‰∏â‰∏™ÁïåÈù¢ÁöÑÊ†áÈ¢òÊ†èÂè™ÂÅö‚Äú‰∏≠Ëã±ÊñáÂàáÈù¢‚Äù
...
detection_menu_def detection_menu;
...
void disp_language_init()
{
    ...
    about_menu.systom_v=INFO_SYSTOM_VAL;
    about_menu.firmware_val=INFO_FIRMWARE_VAL;

    about_menu.website_v=SERVICE_WEBSITE;
    about_menu.email_v=SERVICE_EMAIL;
	...
	switch(gCfgItems.language)
	{
		case LANG_SIMPLE_CHINESE:
			...
			file_menu.no_file_and_check = NO_FILE_AND_CHECK_CN;
			//º∑≥ˆ
            ...
            set_menu.service = SERVICE_CN;
            set_menu.info = INFOMATION_CN;
            ...
            dialog_menu.zoffset_tips=DIALOG_ZOFFSET_TIPS_CN;

            detection_menu.detection_tips=DETECTION_TIP_CN;
            detection_menu.exposure_start=EXPOSURE_TIME_START_CN;
            detection_menu.exposure_ing=EXPOSURE_TIME_ING_CN;
            detection_menu.exposure_end=EXPOSURE_TIME_END_CN;
           dialog_menu.delete_file = DIALOG_DEL_FILE_TIPS_CN; 

           operation_menu.bottomlayer=BOTTOMLAYER_CN;
           operation_menu.exposureoff=EXPOSURE_OFF_CN;
           operation_menu.bottomexposure=BOTTOM_EXPOSURE_CN;
           operation_menu.normalexposure=NORMAL_EXPOSURE_CN;
		...
		case LANG_COMPLEX_CHINESE:
			...
			file_menu.no_file_and_check = NO_FILE_AND_CHECK_T_CN;
			//º∑≥ˆ
            ...
            set_menu.service = SERVICE_T_CN;
            set_menu.info = INFOMATION_T_CN;
            ...
            dialog_menu.zoffset_tips=DIALOG_ZOFFSET_TIPS_T_CN;

            detection_menu.detection_tips=DETECTION_TIP_T_CN;
            detection_menu.exposure_start=EXPOSURE_TIME_START_T_CN;
            detection_menu.exposure_ing=EXPOSURE_TIME_ING_T_CN;
            detection_menu.exposure_end=EXPOSURE_TIME_END_T_CN;
            dialog_menu.delete_file = DIALOG_DEL_FILE_TIPS_T_CN;

           operation_menu.bottomlayer=BOTTOMLAYER_T_CN;
           operation_menu.exposureoff=EXPOSURE_OFF_T_CN;
           operation_menu.bottomexposure=BOTTOM_EXPOSURE_T_CN;
           operation_menu.normalexposure=NORMAL_EXPOSURE_T_CN; 
		...
		case LANG_ENGLISH:
			...
			file_menu.no_file_and_check = NO_FILE_AND_CHECK_EN;			
			//º∑≥ˆ
            ...
            set_menu.service = SERVICE_EN;
            set_menu.info = INFOMATION_EN;
            ...
            dialog_menu.zoffset_tips=DIALOG_ZOFFSET_TIPS_EN;     

            detection_menu.detection_tips=DETECTION_TIP_EN;
            detection_menu.exposure_start=EXPOSURE_TIME_START_EN;
            detection_menu.exposure_ing=EXPOSURE_TIME_ING_EN;
            detection_menu.exposure_end=EXPOSURE_TIME_END_EN;
            dialog_menu.delete_file = DIALOG_DEL_FILE_TIPS_EN;

           operation_menu.bottomlayer=BOTTOMLAYER_EN;
           operation_menu.exposureoff=EXPOSURE_OFF_EN;
           operation_menu.bottomexposure=BOTTOM_EXPOSURE_EN;
           operation_menu.normalexposure=NORMAL_EXPOSURE_EN;   
		...
		case LANG_RUSSIAN:
			...
			file_menu.no_file_and_check = NO_FILE_AND_CHECK_RU;			
			//º∑≥ˆ
            ...
            set_menu.service = SERVICE_RU;
            set_menu.info = INFOMATION_RU;
            ...
            dialog_menu.zoffset_tips=DIALOG_ZOFFSET_TIPS_RU;

            detection_menu.detection_tips=DETECTION_TIP_RU;
            detection_menu.exposure_start=EXPOSURE_TIME_START_RU;
            detection_menu.exposure_ing=EXPOSURE_TIME_ING_RU;
            detection_menu.exposure_end=EXPOSURE_TIME_END_RU;
            dialog_menu.delete_file = DIALOG_DEL_FILE_TIPS_RU;

            operation_menu.bottomlayer=BOTTOMLAYER_RU;
           operation_menu.exposureoff=EXPOSURE_OFF_RU;
           operation_menu.bottomexposure=BOTTOM_EXPOSURE_RU;
           operation_menu.normalexposure=NORMAL_EXPOSURE_RU;  
		...
		case LANG_SPANISH:
			...
			file_menu.no_file_and_check = NO_FILE_AND_CHECK_SP;			
			//º∑≥ˆ
            ...
            set_menu.service = SERVICE_SP;
            set_menu.info = INFOMATION_SP;
            ...
            dialog_menu.zoffset_tips=DIALOG_ZOFFSET_TIPS_SP;  

            detection_menu.detection_tips=DETECTION_TIP_SP;
            detection_menu.exposure_start=EXPOSURE_TIME_START_SP;
            detection_menu.exposure_ing=EXPOSURE_TIME_ING_SP;
            detection_menu.exposure_end=EXPOSURE_TIME_END_SP;     
            dialog_menu.delete_file = DIALOG_DEL_FILE_TIPS_SP;
           operation_menu.bottomlayer=BOTTOMLAYER_SP;
           operation_menu.exposureoff=EXPOSURE_OFF_SP;
           operation_menu.bottomexposure=BOTTOM_EXPOSURE_SP;
           operation_menu.normalexposure=NORMAL_EXPOSURE_SP;   
		...
		case LANG_FRENCH:
			...
			file_menu.no_file_and_check = NO_FILE_AND_CHECK_FR;				
			//WIFI
            ...
            set_menu.service = SERVICE_FR;
            set_menu.info = INFOMATION_FR;
            ...
            dialog_menu.zoffset_tips=DIALOG_ZOFFSET_TIPS_FR;    

            detection_menu.detection_tips=DETECTION_TIP_FR;
            detection_menu.exposure_start=EXPOSURE_TIME_START_FR;
            detection_menu.exposure_ing=EXPOSURE_TIME_ING_FR;
            detection_menu.exposure_end=EXPOSURE_TIME_END_FR;
            dialog_menu.delete_file = DIALOG_DEL_FILE_TIPS_FR;
            operation_menu.bottomlayer=BOTTOMLAYER_FR;
            operation_menu.exposureoff=EXPOSURE_OFF_FR;
            operation_menu.bottomexposure=BOTTOM_EXPOSURE_FR;
            operation_menu.normalexposure=NORMAL_EXPOSURE_FR;
		...
		case LANG_ITALY:
			...
			file_menu.no_file_and_check = NO_FILE_AND_CHECK_IT;				
			//º∑≥ˆ
            ...
            set_menu.service = SERVICE_IT;
            set_menu.info = INFOMATION_IT;
            ...
            dialog_menu.zoffset_tips=DIALOG_ZOFFSET_TIPS_IT;   

            detection_menu.detection_tips=DETECTION_TIP_IT;
            detection_menu.exposure_start=EXPOSURE_TIME_START_IT;
            detection_menu.exposure_ing=EXPOSURE_TIME_ING_IT;
            detection_menu.exposure_end=EXPOSURE_TIME_END_IT;

            dialog_menu.delete_file = DIALOG_DEL_FILE_TIPS_IT;

           operation_menu.bottomlayer=BOTTOMLAYER_IT;
           operation_menu.exposureoff=EXPOSURE_OFF_IT;
           operation_menu.bottomexposure=BOTTOM_EXPOSURE_IT;
           operation_menu.normalexposure=NORMAL_EXPOSURE_IT;   

           about_menu.systom=INFO_SYSTOM_IT;
